...
class SessionApi
{
     ...
     */
    public function sessionsMeGet()
    {
        list($response) = $this->sessionsMeGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation sessionsMeGetWithHttpInfo
     *
     * Get Session
     *
     *
     ...
     */
    public function sessionsMeGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->sessionsMeGetRequest();
     ...
     */
    public function sessionsMeGetAsync()
    {
        return $this->sessionsMeGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sessionsMeGetAsyncWithHttpInfo
     *
     * Get Session
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sessionsMeGetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2003';
        $request = $this->sessionsMeGetRequest();
    ...
    /**
     * Create request for operation 'sessionsMeGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sessionsMeGetRequest()
    {

        $resourcePath = '/sessions/me';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
