...
class CustomersApi
{
     ...
     *
     * @param  string $id id of the customer that need to be deleted (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id id of the customer (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Customers
     ...
     *
     * @param  \Swagger\Client\Model\Customers $body Object data that need to be updated (required)
     * @param  string $id id of the customer that need to be updated (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Customers
     ...
     * Add customer
     *
     * @param  \Swagger\Client\Model\Customers $body Customer object that needs to be added. (required)
     ...
     */
    public function customersPost($body, $pagination = null, $per_page = null, $page = null)
    {
        list($response) = $this->customersPostWithHttpInfo($body, $pagination, $per_page, $page);
        return $response;
    }
     ...
     */
    public function customersPostWithHttpInfo($body, $pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->customersPostRequest($body, $pagination, $per_page, $page);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersPostAsync($body, $pagination = null, $per_page = null, $page = null)
    {
        return $this->customersPostAsyncWithHttpInfo($body, $pagination, $per_page, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersPostAsyncWithHttpInfo($body, $pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2011';
        $request = $this->customersPostRequest($body, $pagination, $per_page, $page);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function customersPostRequest($body, $pagination = null, $per_page = null, $page = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
