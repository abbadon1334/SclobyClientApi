...
/**
 * LoyaltyProgramCustomerPointsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LoyaltyProgramCustomerPointsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation fidelitiesPointsIdGet
     *
     * Get existing Fidelity Point
     *
     * @param  string $id id of the Fidelity Point (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse2004
     */
    public function fidelitiesPointsIdGet($id)
    {
        list($response) = $this->fidelitiesPointsIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation fidelitiesPointsIdGetWithHttpInfo
     *
     * Get existing Fidelity Point
     *
     * @param  string $id id of the Fidelity Point (required)
     ...
     */
    public function fidelitiesPointsIdGetWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2004';
        $request = $this->fidelitiesPointsIdGetRequest($id);
    ...
    /**
     * Operation fidelitiesPointsIdGetAsync
     *
     * Get existing Fidelity Point
     *
     * @param  string $id id of the Fidelity Point (required)
     ...
     */
    public function fidelitiesPointsIdGetAsync($id)
    {
        return $this->fidelitiesPointsIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation fidelitiesPointsIdGetAsyncWithHttpInfo
     *
     * Get existing Fidelity Point
     *
     * @param  string $id id of the Fidelity Point (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function fidelitiesPointsIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2004';
        $request = $this->fidelitiesPointsIdGetRequest($id);
    ...
    /**
     * Create request for operation 'fidelitiesPointsIdGet'
     *
     * @param  string $id id of the Fidelity Point (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function fidelitiesPointsIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling fidelitiesPointsIdGet'
            );
        }

        $resourcePath = '/fidelities_points/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
