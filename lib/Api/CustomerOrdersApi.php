...
class CustomerOrdersApi
{
     ...
     */
    public function ordersGet($pagination = null, $per_page = null, $page = null)
    {
        list($response) = $this->ordersGetWithHttpInfo($pagination, $per_page, $page);
        return $response;
    }
     ...
     */
    public function ordersGetWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\Orders';
        $request = $this->ordersGetRequest($pagination, $per_page, $page);
     ...
     */
    public function ordersGetAsync($pagination = null, $per_page = null, $page = null)
    {
        return $this->ordersGetAsyncWithHttpInfo($pagination, $per_page, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ordersGetAsyncWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\Orders';
        $request = $this->ordersGetRequest($pagination, $per_page, $page);
     ...
     */
    protected function ordersGetRequest($pagination = null, $per_page = null, $page = null)
    {
     ...
     *
     * @param  string $id id of the Order that need to be deleted (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Edit existing Order
     *
     * @param  \Swagger\Client\Model\Orders $body Object data that need to be updated (required)
     * @param  string $id id of the Order that need to be updated (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Orders
     ...
     * Add new Order
     *
     * @param  \Swagger\Client\Model\Orders $body Order object that needs to be added. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Orders
