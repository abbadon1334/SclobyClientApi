...
/**
 * AllergensApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class AllergensApi
{
     ...
     */
    public function allergensGet($pagination = null, $per_page = null, $page = null)
    {
        list($response) = $this->allergensGetWithHttpInfo($pagination, $per_page, $page);
        return $response;
    }

    /**
     * Operation allergensGetWithHttpInfo
     *
     * Get All Allergens
     *
     * @param  bool $pagination Pagination parameter (optional)
     ...
     */
    public function allergensGetWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001[]';
        $request = $this->allergensGetRequest($pagination, $per_page, $page);
     ...
     */
    public function allergensGetAsync($pagination = null, $per_page = null, $page = null)
    {
        return $this->allergensGetAsyncWithHttpInfo($pagination, $per_page, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation allergensGetAsyncWithHttpInfo
     *
     * Get All Allergens
     *
     * @param  bool $pagination Pagination parameter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function allergensGetAsyncWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001[]';
        $request = $this->allergensGetRequest($pagination, $per_page, $page);
    ...
    /**
     * Create request for operation 'allergensGet'
     *
     * @param  bool $pagination Pagination parameter (optional)
     * @param  int $per_page Results_per_page (optional)
     * @param  int $page PAGE_NUMBER(starting from 0 to TOTAL_PAGE-1) (optional)
     ...
     */
    protected function allergensGetRequest($pagination = null, $per_page = null, $page = null)
    {

        $resourcePath = '/allergens';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation allergensIdGet
     *
     * Get existing Allergen
     *
     * @param  string $id id of the allergen (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse2001
     */
    public function allergensIdGet($id)
    {
        list($response) = $this->allergensIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation allergensIdGetWithHttpInfo
     *
     * Get existing Allergen
     *
     * @param  string $id id of the allergen (required)
     ...
     * @return array of \Swagger\Client\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function allergensIdGetWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->allergensIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function allergensIdGetAsync($id)
    {
        return $this->allergensIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation allergensIdGetAsyncWithHttpInfo
     *
     * Get existing Allergen
     *
     * @param  string $id id of the allergen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function allergensIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse2001';
        $request = $this->allergensIdGetRequest($id);
    ...
    /**
     * Create request for operation 'allergensIdGet'
     *
     * @param  string $id id of the allergen (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function allergensIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling allergensIdGet'
            );
        }

        $resourcePath = '/allergens/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
