...
class ItemsApi
{
     ...
     * GET All items
     *
     * @param  bool $pagination Pagination param (optional)
     ...
     */
    public function itemsGet($pagination = null, $per_page = null, $page = null)
    {
        list($response) = $this->itemsGetWithHttpInfo($pagination, $per_page, $page);
        return $response;
    }
     ...
     */
    public function itemsGetWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsGetRequest($pagination, $per_page, $page);
     ...
     */
    public function itemsGetAsync($pagination = null, $per_page = null, $page = null)
    {
        return $this->itemsGetAsyncWithHttpInfo($pagination, $per_page, $page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsGetAsyncWithHttpInfo($pagination = null, $per_page = null, $page = null)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsGetRequest($pagination, $per_page, $page);
     ...
     */
    protected function itemsGetRequest($pagination = null, $per_page = null, $page = null)
    {
     ...
     *
     * @param  string $id id of the item that need to be deleted (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function itemsIdDelete($id)
    {
        $this->itemsIdDeleteWithHttpInfo($id);
    }

    /**
     * Operation itemsIdDeleteWithHttpInfo
     *
     * Delete existing Item
     *
     * @param  string $id id of the item that need to be deleted (required)
     ...
     */
    public function itemsIdDeleteWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->itemsIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsIdDeleteAsync($id)
    {
        return $this->itemsIdDeleteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation itemsIdDeleteAsyncWithHttpInfo
     *
     * Delete existing Item
     *
     * @param  string $id id of the item that need to be deleted (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsIdDeleteAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->itemsIdDeleteRequest($id);
    ...
    /**
     * Create request for operation 'itemsIdDelete'
     *
     * @param  string $id id of the item that need to be deleted (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function itemsIdDeleteRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling itemsIdDelete'
            );
        }
     ...
     * Edit existing item
     *
     * @param  \Swagger\Client\Model\Items $body Object data that need to be updated (required)
     * @param  string $id id of the item that need to be updated (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Items
     */
    public function itemsIdPut($body, $id)
    {
        list($response) = $this->itemsIdPutWithHttpInfo($body, $id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Items, HTTP status code, HTTP response headers (array of strings)
     */
    public function itemsIdPutWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsIdPutRequest($body, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsIdPutAsync($body, $id)
    {
        return $this->itemsIdPutAsyncWithHttpInfo($body, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsIdPutAsyncWithHttpInfo($body, $id)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsIdPutRequest($body, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function itemsIdPutRequest($body, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling itemsIdPut'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
     ...
     * Add new Item
     *
     * @param  \Swagger\Client\Model\Items $body Item object that needs to be added. (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Items
     */
    public function itemsPost($body)
    {
        list($response) = $this->itemsPostWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\Items, HTTP status code, HTTP response headers (array of strings)
     */
    public function itemsPostWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsPostAsync($body)
    {
        return $this->itemsPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function itemsPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\Items';
        $request = $this->itemsPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function itemsPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling itemsPost'
            );
        }
