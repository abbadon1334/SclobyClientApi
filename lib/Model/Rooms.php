 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Rooms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'rooms';
...
'updatedby_id' => 'int',
'deletedby_id' => 'int',
'tables' => '\Swagger\Client\Model\TableSchema[]'    ];
...
'tables' => 'getTables'    ];
     ...
     * Gets tables
     *
     * @return \Swagger\Client\Model\TableSchema[]
     */
     ...
     * Sets tables
     *
     * @param \Swagger\Client\Model\TableSchema[] $tables tables
     *
     * @return $this
     */
